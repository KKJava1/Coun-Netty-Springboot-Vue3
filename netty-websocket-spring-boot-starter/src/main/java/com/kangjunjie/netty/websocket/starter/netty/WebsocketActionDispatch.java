package com.kangjunjie.netty.websocket.starter.netty;

import com.kangjunjie.netty.websocket.starter.support.MethodParamsBuild;
import com.kangjunjie.netty.websocket.starter.support.WebsocketServerEndpoint;
...
public class WebsocketActionDispatch {
    ...
    protected boolean verifyUri(String uri) {
        /**
         * 通过anyMath进行遍历(返回的是boolean值).在通过正则表达式进行一个校验处理
         */
