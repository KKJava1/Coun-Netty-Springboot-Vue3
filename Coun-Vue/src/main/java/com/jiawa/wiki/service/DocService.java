...
import com.jiawa.wiki.task.ExecuteQueueTaskServiceImpl;
...
public class DocService {
    ...
    @Resource
    private ExecuteQueueTaskServiceImpl executeQueueTaskService;
    @Autowired
...
//     private RocketMQTemplate rocketMQTemplate;
    ...
    public String findContent(Long id) {
        ...
        public void vote(Long id) {
            ...
            //执行延时任务
//            QueueTask queueTask = new QueueTask(executeQueueTaskService.getTaskType(), docDb.getName(), LocalDateTime.now().plusSeconds(1L));
//            queueTaskService.addTaskWithDelay(queueTask, 1L);
//
//            QueueTask task2 = new QueueTask("redisson-task02", "任务内容02", LocalDateTime.now());
//            queueTaskService.addTaskWithDelay(task2, 10);
